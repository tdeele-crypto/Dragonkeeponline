...
export const UI_TEXT: Record<Language, Record<string, string>> = {
  da: {
    ...
    'overview.selectDragonTitle': 'Vælg agame',
    'overview.selectDragonToPrint': 'Vælg hvilken agame ugeplanen skal printes for',
    ...
    'admin.shareSectionTitle': 'Invitér & del plejeplan',
    'admin.shareSectionSubtitle':
      'Invitér en person via email. De får en kode, som de indtaster ved oprettelse, og deler så din plejeplan (agamer, plan og afkrydsninger).',
    'admin.inviteEmailLabel': 'Email',
    'admin.inviteEmailPlaceholder': 'person@eksempel.dk',
    'admin.inviteButton': 'Opret invitation',
    'admin.inviteInvalidEmail': 'Indtast en gyldig email',
    'admin.inviteCreated': 'Invitation oprettet',
    'admin.inviteError': 'Kunne ikke oprette invitation',
    'admin.invitePendingHeading': 'Afventende invitationer',
    'admin.inviteCodeLabel': 'Kode',
    'admin.inviteShareMessage': 'Deltag i min Dragon Keeper-plejeplan! Opret en konto på {{email}} og brug invitationskoden: {{code}}',
    'admin.inviteDeleteTitle': 'Slet invitation?',
    'admin.inviteDeleteConfirm': 'Slet',
    'admin.inviteDeleted': 'Invitation slettet',
    'admin.shareMembersHeading': 'Medlemmer',
    'admin.shareMemberYou': 'dig',
    'admin.accountSectionTitle': 'Konto',
    'admin.accountSuperadmin': 'Superadmin',
    'admin.accountUser': 'Bruger',
    'admin.manageUsersButton': 'Administrér brugere',
    'admin.logoutTitle': 'Log ud?',
    'admin.logoutMessage': 'Du bliver logget ud af din konto.',
    'admin.logoutButton': 'Log ud',
  ...
  en: {
    ...
    'overview.selectDragonTitle': 'Choose dragon',
    'overview.selectDragonToPrint': 'Choose which dragon to print the weekly plan for',
    ...
    'admin.shareSectionTitle': 'Invite & share care plan',
    'admin.shareSectionSubtitle':
      'Invite someone by email. They get a code to enter when signing up, then share your care plan (dragons, plan and checkmarks).',
    'admin.inviteEmailLabel': 'Email',
    'admin.inviteEmailPlaceholder': 'person@example.com',
    'admin.inviteButton': 'Create invite',
    'admin.inviteInvalidEmail': 'Enter a valid email',
    'admin.inviteCreated': 'Invite created',
    'admin.inviteError': 'Could not create invite',
    'admin.invitePendingHeading': 'Pending invites',
    'admin.inviteCodeLabel': 'Code',
    'admin.inviteShareMessage': 'Join my Dragon Keeper care plan! Sign up with {{email}} and use invite code: {{code}}',
    'admin.inviteDeleteTitle': 'Delete invite?',
    'admin.inviteDeleteConfirm': 'Delete',
    'admin.inviteDeleted': 'Invite deleted',
    'admin.shareMembersHeading': 'Members',
    'admin.shareMemberYou': 'you',
    'admin.accountSectionTitle': 'Account',
    'admin.accountSuperadmin': 'Superadmin',
    'admin.accountUser': 'User',
    'admin.manageUsersButton': 'Manage users',
    'admin.logoutTitle': 'Log out?',
    'admin.logoutMessage': 'You will be signed out of your account.',
